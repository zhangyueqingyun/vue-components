import { resolveComponent as Gr, openBlock as Vr, createBlock as Wr, withCtx as Ur, createTextVNode as Yr, Fragment as Tt, isVNode as qr, Comment as Kr, Text as Dn, defineComponent as te, inject as _t, computed as N, createVNode as m, reactive as ae, provide as Je, watch as Me, Transition as Jr, onMounted as Xe, onUnmounted as Xr, Teleport as Qr, ref as be, TransitionGroup as Zr, render as Wt, h as Ut, nextTick as At, watchEffect as Le, getCurrentInstance as ea, onBeforeUnmount as Bn, onUpdated as ta } from "vue";
const na = (e, t) => {
  const n = e.__vccOpts || e;
  for (const [r, a] of t)
    n[r] = a;
  return n;
}, ra = {}, aa = /* @__PURE__ */ Yr("\u6211\u662F\u6309\u94AE");
function oa(e, t) {
  const n = Gr("a-button");
  return Vr(), Wr(n, null, {
    default: Ur(() => [
...
const ia = /* @__PURE__ */ na(ra, [["render", oa]]);
function fe(e) {
...
var ua = Array.isArray, sa = function(t) {
...
const xa = Ca;
var Oa = Symbol("skipFlatten"), zn = function e() {
  ...
  return r.forEach(function(o) {
    Array.isArray(o) ? a.push.apply(a, Ye(e(o, n))) : o && o.type === Tt ? o.key === Oa ? a.push(o) : a.push.apply(a, Ye(e(o.children, n))) : o && qr(o) ? n && !Gn(o) ? a.push(o) : n || a.push(o) : ba(o) && a.push(o);
  }), a;
}, Kt = function(t) {
...
function Gn(e) {
  return e && (e.type === Kr || e.type === Tt && e.children.length === 0 || e.type === Dn && e.children.trim() === "");
}
function Vn() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [], t = [];
  return e.forEach(function(n) {
    Array.isArray(n) ? t.push.apply(t, Ye(n)) : (n == null ? void 0 : n.type) === Tt ? t.push.apply(t, Ye(Vn(n.children))) : t.push(n);
  }), t.filter(function(n) {
    return !Gn(n);
  });
}
...
var Aa = {
  ...
  timePickerLocale: k({}, Jn)
};
const Xt = Aa;
var W = "${label} is not a valid ${type}", ja = {
  locale: "en",
  Pagination: Pa,
  DatePicker: Xt,
  TimePicker: Jn,
...
var rr = Object.prototype, ar = rr.toString, $a = rr.hasOwnProperty, or = /^\s*function (\w+)/;
function en(e) {
...
var $e = function(e, t) {
  return $a.call(e, t);
}, Na = Number.isInteger || function(e) {
...
function ve(e, t, n) {
  ...
  if (cr(r) && r.type !== null) {
    ...
    xe(r.type) ? (a = r.type.some(function(l) {
      ...
      if (l == null)
        return "";
      var f = l.constructor.toString().match(or);
      return f ? f[1] : "";
...
function tn(e, t, n) {
  ...
  if (o._vueTypes_name = e, !de(n))
    return o;
  var c, i, u = n.validator, d = nr(n, ["validator"]);
  if (Oe(u)) {
    var v = o.validator;
...
var Z = function() {
  ...
  return e.extend = function(t) {
    ...
    return Fa().def(this.defaults.func);
    ...
    return Ha().def(this.defaults.array);
  } }, { key: "object", get: function() {
    return za().def(this.defaults.object);
  } }, { key: "integer", get: function() {
    return Ga().def(this.defaults.integer);
...
Z.defaults = {}, Z.custom = Wa, Z.oneOf = Ua, Z.instanceOf = Ka, Z.oneOfType = Ya, Z.arrayOf = qa, Z.objectOf = Ja, Z.shape = Xa, Z.utils = { validate: function(e, t) {
  return ve(t, e, !0) === !0;
...
const vt = ur;
var Qa = ["image", "description", "imageStyle", "class"], sr = m(ka, null, null), fr = m(Ma, null, null), we = function(t, n) {
  var r, a = n.slots, o = a === void 0 ? {} : a, c = n.attrs, i = pe("empty", t), u = i.direction, d = i.prefixCls, v = d.value, l = k(k({}, t), c), f = l.image, p = f === void 0 ? sr : f, y = l.description, E = y === void 0 ? ((r = o.description) === null || r === void 0 ? void 0 : r.call(o)) || void 0 : y, _ = l.imageStyle, j = l.class, w = j === void 0 ? "" : j, $ = Kn(l, Qa);
  return m(Xn, {
    componentName: "Empty",
    children: function(A) {
      var b, S = typeof E < "u" ? E : A.description, x = typeof S == "string" ? S : "empty", T = null;
      return typeof p == "string" ? T = m("img", {
        alt: x,
        src: p
      }, null) : T = p, m("div", k({
        class: Fe(v, w, (b = {}, L(b, "".concat(v, "-normal"), p === fr), L(b, "".concat(v, "-rtl"), u.value === "rtl"), b))
      }, $), [m("div", {
...
we.PRESENTED_IMAGE_DEFAULT = sr;
we.PRESENTED_IMAGE_SIMPLE = fr;
we.inheritAttrs = !1;
we.props = {
  prefixCls: String,
  image: vt.any,
...
var pt = "internalMark", We = te({
  ...
  setup: function(t, n) {
    var r = n.slots;
    no(t.ANT_MARK__ === pt, "LocaleProvider", "`LocaleProvider` is deprecated. Please use `locale` with `ConfigProvider` instead");
    var a = ae({
...
const oo = te({
  ...
  setup: function(t, n) {
    ...
    return Xe(function() {
      ...
      var p = qt(l, 3), y = p[0], E = p[1], _ = p[2], j = qt(f, 3), w = j[0], $ = j[1], M = j[2];
      (y !== w || E !== $ || _ !== M && M) && v();
    }, {
      flush: "post"
    }), function() {
      var l, f, p = t.prefixCls, y = t.closable, E = t.closeIcon, _ = E === void 0 ? (l = a.closeIcon) === null || l === void 0 ? void 0 : l.call(a) : E, j = t.onClick, w = t.holder, $ = r.class, M = r.style, A = "".concat(p, "-notice"), b = Object.keys(r).reduce(function(x, T) {
        return (T.startsWith("data-") || T.startsWith("aria-") || T === "role") && (x[T] = r[T]), x;
      }, {}), S = m("div", k({
        class: Fe(A, $, L({}, "".concat(A, "-closable"), y)),
        style: M,
        onMouseenter: u,
        onMouseleave: i,
        onClick: j
...
var io = ["name", "getContainer", "appContext", "prefixCls", "rootPrefixCls", "transitionName", "hasTransitionName"], rn = 0, co = Date.now();
function an() {
  var e = rn;
  return rn += 1, "rcNotification_".concat(co, "_").concat(e);
}
var ht = te({
  name: "Notification",
  inheritAttrs: !1,
  ...
  setup: function(t, n) {
    var r = n.attrs, a = n.expose, o = n.slots, c = /* @__PURE__ */ new Map(), i = be([]), u = N(function() {
      ...
      return !y && p && (y = "".concat(l, "-").concat(p)), ao(y);
    }), d = function(f, p) {
      var y = f.key || an(), E = k(k({}, f), {}, {
        key: y
      }), _ = t.maxCount, j = i.value.map(function($) {
        return $.notice.key;
      ...
      i.value = i.value.filter(function(p) {
        var y = p.notice, E = y.key, _ = y.userPassKey, j = _ || E;
        return j !== f;
      });
    };
    return a({
      ...
      var l, f, p = t.prefixCls, y = t.closeIcon, E = y === void 0 ? (l = o.closeIcon) === null || l === void 0 ? void 0 : l.call(o, {
        ...
        var M = w.notice, A = w.holderCallback, b = $ === i.value.length - 1 ? M.updateMark : void 0, S = M.key, x = M.userPassKey, T = M.content, R = k(k(k({
          prefixCls: p,
        ...
        return A ? m("div", {
          ...
          ref: function(D) {
            typeof S > "u" || (D ? (c.set(S, D), A(D, R)) : c.delete(S));
          }
        }, null) : m(oo, R, {
          default: function() {
      ...
      }), j = (f = {}, L(f, p, 1), L(f, r.class, !!r.class), f);
      return m("div", {
        class: j,
        style: r.style || {
          top: "65px",
...
ht.newInstance = function(t, n) {
  var r = t || {}, a = r.name, o = a === void 0 ? "notification" : a, c = r.getContainer, i = r.appContext, u = r.prefixCls, d = r.rootPrefixCls, v = r.transitionName, l = r.hasTransitionName, f = Kn(r, io), p = document.createElement("div");
  if (c) {
    var y = c();
    y.appendChild(p);
  } else
    ...
    setup: function(w, $) {
      ...
      return Xe(function() {
        n({
          notice: function(S) {
            var x;
            (x = A.value) === null || x === void 0 || x.add(S);
          },
          removeNotice: function(S) {
            var x;
            (x = A.value) === null || x === void 0 || x.remove(S);
          },
          destroy: function() {
...
function ge(e) {
  ...
  return typeof e == "string" && (e = xo(e)), typeof e == "object" && (re(e.r) && re(e.g) && re(e.b) ? (t = vo(e.r, e.g, e.b), c = !0, i = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : re(e.h) && re(e.s) && re(e.v) ? (r = De(e.s), a = De(e.v), t = ho(e.h, r, a), c = !0, i = "hsv") : re(e.h) && re(e.s) && re(e.l) && (r = De(e.s), o = De(e.l), t = po(e.h, r, o), c = !0, i = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (n = e.a)), n = hr(n), {
    ok: c,
    format: e.format || i,
...
var bo = "[-\\+]?\\d+%?", Co = "[-\\+]?\\d*\\.\\d+%?", ie = "(?:".concat(Co, ")|(?:").concat(bo, ")"), et = "[\\s|\\(]+(".concat(ie, ")[,|\\s]+(").concat(ie, ")[,|\\s]+(").concat(ie, ")\\s*\\)?"), tt = "[\\s|\\(]+(".concat(ie, ")[,|\\s]+(").concat(ie, ")[,|\\s]+(").concat(ie, ")[,|\\s]+(").concat(ie, ")\\s*\\)?"), X = {
...
var nt = function() {
  function e(t, n) {
    ...
    if (t instanceof e)
      return t;
    typeof t == "number" && (t = yo(t)), this.originalInput = t;
    var a = ge(t);
...
}(), Be = 2, ln = 0.16, Oo = 0.05, wo = 0.05, So = 0.15, gr = 5, mr = 4, Po = [{
  index: 7,
  opacity: 0.15
}, {
  index: 6,
...
function fn(e, t, n) {
  if (e.h === 0 && e.s === 0)
    return e.s;
  var r;
  return n ? r = e.s - ln * t : t === mr ? r = e.s + ln : r = e.s + Oo * t, r > 1 && (r = 1), n && t === gr && r > 0.1 && (r = 0.1), r < 0.06 && (r = 0.06), Number(r.toFixed(2));
}
function dn(e, t, n) {
  var r;
  return n ? r = e.v + wo * t : r = e.v - So * t, r > 1 && (r = 1), Number(r.toFixed(2));
}
function Ie(e) {
  for (var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = [], r = ge(e), a = gr; a > 0; a -= 1) {
    var o = un(r), c = He(ge({
      h: sn(o, a, !0),
      s: fn(o, a, !0),
      v: dn(o, a, !0)
  ...
  return t.theme === "dark" ? Po.map(function(v) {
    var l = v.index, f = v.opacity, p = He(Eo(ge(t.backgroundColor || "#141414"), ge(n[l]), f * 100));
    return p;
  }) : n;
}
var rt = {
...
var vn = [], Te = [], To = "insert-css: You need to provide a CSS string. Usage: insertCss(cssString[, options]).";
function _o() {
...
function Ao(e, t) {
  ...
  var o;
  return Te[a] !== void 0 && Te[a][n] !== void 0 ? o = Te[a][n] : (o = Te[a][n] = _o(), n === "prepend" ? r.insertBefore(o, r.childNodes[0]) : r.appendChild(o)), e.charCodeAt(0) === 65279 && (e = e.substr(1, e.length)), o.styleSheet ? o.styleSheet.cssText += e : o.textContent += e, o;
}
function pn(e) {
  for (var t = 1; t < arguments.length; t++) {
...
function Mo(e, t) {
  ko(e, "[@ant-design/icons-vue] ".concat(t));
}
function hn(e) {
...
`, gn = !1, Io = function() {
  var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : $o;
  At(function() {
    gn || (typeof window < "u" && window.document && window.document.documentElement && Ao(t, {
      prepend: !0
    }), gn = !0);
  });
}, No = ["icon", "primaryColor", "secondaryColor"];
function Lo(e, t) {
  if (e == null)
    return {};
  var n = Fo(e, t), r, a;
...
function Do(e) {
  ...
  Ae.primaryColor = t, Ae.secondaryColor = n || yr(t), Ae.calculated = !!n;
}
function Bo() {
  return Ue({}, Ae);
}
var Se = function(t, n) {
  var r = Ue({}, t, n.attrs), a = r.icon, o = r.primaryColor, c = r.secondaryColor, i = Lo(r, No), u = Ae;
  if (o && (u = {
    primaryColor: o,
    secondaryColor: c || yr(o)
  }), Io(), Mo(hn(a), "icon should be icon definiton, but got ".concat(a)), !hn(a))
    return null;
  var d = a;
...
Se.getTwoToneColors = Bo;
Se.setTwoToneColors = Do;
const Mt = Se;
function Ho(e, t) {
  return Wo(e) || Vo(e, t) || Go(e, t) || zo();
}
function zo() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function Cr(e) {
  var t = br(e), n = Ho(t, 2), r = n[0], a = n[1];
...
Cr("#1890ff");
var Pe = function(t, n) {
  var r, a = bn({}, t, n.attrs), o = a.class, c = a.icon, i = a.spin, u = a.rotate, d = a.tabindex, v = a.twoToneColor, l = a.onClick, f = Zo(a, Yo), p = (r = {
    anticon: !0
  ...
  } : void 0, j = br(v), w = qo(j, 2), $ = w[0], M = w[1];
  return m("span", bn({
    role: "img",
    "aria-label": c.name
  }, f, {
...
Pe.inheritAttrs = !1;
Pe.getTwoToneColor = Uo;
Pe.setTwoToneColor = Cr;
const ne = Pe;
function Cn(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
$t.inheritAttrs = !1;
const xt = $t;
var ni = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm-32 232c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8v272c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8V296zm32 440a48.01 48.01 0 010-96 48.01 48.01 0 010 96z" } }] }, name: "exclamation-circle", theme: "filled" };
const ri = ni;
function xn(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
It.inheritAttrs = !1;
const oi = It;
var ii = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm165.4 618.2l-66-.3L512 563.4l-99.3 118.4-66.1.3c-4.4 0-8-3.5-8-8 0-1.9.7-3.7 1.9-5.2l130.1-155L340.5 359a8.32 8.32 0 01-1.9-5.2c0-4.4 3.6-8 8-8l66.1.3L512 464.6l99.3-118.4 66-.3c4.4 0 8 3.5 8 8 0 1.9-.7 3.7-1.9 5.2L553.5 514l130 155c1.2 1.5 1.9 3.3 1.9 5.2 0 4.4-3.6 8-8 8z" } }] }, name: "close-circle", theme: "filled" };
const ci = ii;
function On(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
Nt.inheritAttrs = !1;
const ui = Nt;
var si = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 01-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z" } }] }, name: "check-circle", theme: "filled" };
const fi = si;
function wn(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
Lt.inheritAttrs = !1;
const vi = Lt;
var pi = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm32 664c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8V456c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8v272zm-32-344a48.01 48.01 0 010-96 48.01 48.01 0 010 96z" } }] }, name: "info-circle", theme: "filled" };
const hi = pi;
function Sn(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
Ft.inheritAttrs = !1;
const mi = Ft;
var xr = 3, Or, V, yi = 1, wr = "", Sr = "move-up", Pr = !1, Er = function() {
...
function Ci(e) {
  e.top !== void 0 && (Or = e.top, V = null), e.duration !== void 0 && (xr = e.duration), e.prefixCls !== void 0 && (wr = e.prefixCls), e.getContainer !== void 0 && (Er = e.getContainer, V = null), e.transitionName !== void 0 && (Sr = e.transitionName, V = null, Pr = !0), e.maxCount !== void 0 && (Tr = e.maxCount, V = null), e.rtl !== void 0 && (_r = e.rtl);
}
function xi(e, t) {
  if (V) {
    t(V);
  ...
  pr.newInstance({
    ...
    getContainer: Er || e.getPopupContainer,
    maxCount: Tr,
    name: "message"
  }, function(n) {
    if (V) {
...
function wi(e) {
  var t = e.duration !== void 0 ? e.duration : xr, n = e.key || bi(), r = new Promise(function(o) {
    var c = function() {
    ...
    xi(e, function(i) {
      i.notice({
        ...
        class: e.class,
        content: function(d) {
          var v, l = d.prefixCls, f = Ar[e.type], p = f ? m(f, null, null) : "", y = Fe("".concat(l, "-custom-content"), (v = {}, L(v, "".concat(l, "-").concat(e.type), e.type), L(v, "".concat(l, "-rtl"), _r === !0), v));
          return m("div", {
            class: y
...
(function(e) {
  ...
  function n() {
    ...
    var A = j.prototype = E.prototype = Object.create(w);
    function b(g) {
    ...
    return _.prototype = j, c(A, "constructor", {
      value: j,
      configurable: !0
    }), c(j, "constructor", {
      value: _,
      configurable: !0
    }), _.displayName = l(j, v, "GeneratorFunction"), r.isGeneratorFunction = function(g) {
      var s = typeof g == "function" && g.constructor;
      return !!s && (s === _ || (s.displayName || s.name) === "GeneratorFunction");
    }, r.mark = function(g) {
      return Object.setPrototypeOf ? Object.setPrototypeOf(g, j) : (g.__proto__ = j, l(g, v, "GeneratorFunction")), g.prototype = Object.create(A), g;
    }, r.awrap = function(g) {
      return {
        __await: g
      };
    ...
    }, b(A), l(A, v, "Generator"), l(A, u, function() {
      return this;
...
var Ti = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M699 353h-46.9c-10.2 0-19.9 4.9-25.9 13.3L469 584.3l-71.2-98.8c-6-8.3-15.6-13.3-25.9-13.3H325c-6.5 0-10.3 7.4-6.5 12.7l124.6 172.8a31.8 31.8 0 0051.7 0l210.6-292c3.9-5.3.1-12.7-6.4-12.7z" } }, { tag: "path", attrs: { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z" } }] }, name: "check-circle", theme: "outlined" };
const _i = Ti;
function Pn(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
Dt.inheritAttrs = !1;
const Ii = Dt;
var Ni = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M685.4 354.8c0-4.4-3.6-8-8-8l-66 .3L512 465.6l-99.3-118.4-66.1-.3c-4.4 0-8 3.5-8 8 0 1.9.7 3.7 1.9 5.2l130.1 155L340.5 670a8.32 8.32 0 00-1.9 5.2c0 4.4 3.6 8 8 8l66.1-.3L512 564.4l99.3 118.4 66 .3c4.4 0 8-3.5 8-8 0-1.9-.7-3.7-1.9-5.2L553.5 515l130.1-155c1.2-1.4 1.8-3.3 1.8-5.2z" } }, { tag: "path", attrs: { d: "M512 65C264.6 65 64 265.6 64 513s200.6 448 448 448 448-200.6 448-448S759.4 65 512 65zm0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z" } }] }, name: "close-circle", theme: "outlined" };
const Li = Ni;
function Tn(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
Ht.inheritAttrs = !1;
const zi = Ht;
var Gi = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M563.8 512l262.5-312.9c4.4-5.2.7-13.1-6.1-13.1h-79.8c-4.7 0-9.2 2.1-12.3 5.7L511.6 449.8 295.1 191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 00203 838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 6.1-13.1L563.8 512z" } }] }, name: "close", theme: "outlined" };
const Vi = Gi;
function An(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, r = Object.keys(n);
...
zt.inheritAttrs = !1;
const Ui = zt;
var ue = {}, Mr = 4.5, $r = "24px", Ir = "24px", Ot = "", Nr = "topRight", Lr = function() {
  return document.body;
}, Fr = null, wt = !1, Rr;
function Yi(e) {
  var t = e.duration, n = e.placement, r = e.bottom, a = e.top, o = e.getContainer, c = e.closeIcon, i = e.prefixCls;
  i !== void 0 && (Ot = i), t !== void 0 && (Mr = t), n !== void 0 && (Nr = n), r !== void 0 && (Ir = typeof r == "number" ? "".concat(r, "px") : r), a !== void 0 && ($r = typeof a == "number" ? "".concat(a, "px") : a), o !== void 0 && (Lr = o), c !== void 0 && (Fr = c), e.rtl !== void 0 && (wt = e.rtl), e.maxCount !== void 0 && (Rr = e.maxCount);
}
function qi(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : $r, n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Ir, r;
  switch (e) {
    case "top":
      r = {
        left: "50%",
...
function Ki(e, t) {
  var n = e.prefixCls, r = e.placement, a = r === void 0 ? Nr : r, o = e.getContainer, c = o === void 0 ? Lr : o, i = e.top, u = e.bottom, d = e.closeIcon, v = d === void 0 ? Fr : d, l = e.appContext, f = fc(), p = f.getPrefixCls, y = p("notification", n || Ot), E = "".concat(y, "-").concat(a, "-").concat(wt), _ = ue[E];
  if (_) {
  ...
  var j = Fe("".concat(y, "-").concat(a), L({}, "".concat(y, "-rtl"), wt === !0));
  pr.newInstance({
    name: "notification",
    prefixCls: n || Ot,
    class: j,
...
function Xi(e) {
  var t = e.icon, n = e.type, r = e.description, a = e.message, o = e.btn, c = e.duration === void 0 ? Mr : e.duration;
  Ki(e, function(i) {
    i.notice({
      content: function(d) {
...
function tc(e) {
  ...
  return Array.from(St.get(n).children).find(function(r) {
    return r.tagName === "STYLE" && r.getAttribute(Br(t)) === e;
  });
}
function nc(e, t) {
  var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, r = Gt(n);
  if (!St.has(r)) {
    var a = jn("", n), o = a.parentNode;
  ...
  var v = jn(e, n);
  return v.setAttribute(Br(n), t), v;
}
const Vt = function(e, t, n) {
  vr(e, "[ant-design-vue: ".concat(t, "] ").concat(n));
};
var rc = "-ant-".concat(Date.now(), "-").concat(Math.random());
function ac(e, t) {
...
function oc(e, t) {
  var n = ac(e, t);
  Dr() ? nc(n, "".concat(rc, "-dynamic-theme")) : Vt(!1, "ConfigProvider", "SSR do not support dynamic theme with css variables.");
}
var ic = Symbol("GlobalFormContextKey"), cc = function(t) {
  Je(ic, t);
}, lc = function() {
  return {
    getTargetContainer: {
...
function Ce() {
  return Y.prefixCls || uc;
}
var Pt = ae({}), Hr = ae({}), Y = ae({});
Le(function() {
  ce(Y, Pt, Hr), Y.prefixCls = Ce(), Y.getPrefixCls = function(e, t) {
...
var ct, sc = function(t) {
  ct && ct(), ct = Le(function() {
    ce(Hr, ae(t)), ce(Y, ae(t));
  }), t.theme && oc(Ce(), t.theme);
}, fc = function() {
  return {
  ...
  setup: function(t, n) {
    var r = n.slots, a = function(l, f) {
      ...
      var f = t.renderEmpty || r.renderEmpty || dr;
      return f(l);
    }, c = function(l, f) {
      var p = t.prefixCls;
      if (f)
...
const pe = function(e, t) {
  var n = _t("configProvider", dc), r = N(function() {
...
typeof window < "u" && typeof document < "u" && pc();
function kn(e, t, n) {
...
const mc = te({
  ...
  setup: function(t, n) {
    var r = n.slots, a = n.expose, o = ea(), c = pe("", t), i = c.csp, u = c.prefixCls;
    a({
      csp: i
    });
    var d = null, v = null, l = null, f = !1, p = null, y = !1, E = function(b) {
      ...
      if (!(T || !b || $n(b) || b.className.indexOf("-leave") >= 0)) {
        ...
        var R = j();
        if (b.removeAttribute(R), b.setAttribute(R, "true"), oe = oe || document.createElement("style"), S && S !== "#ffffff" && S !== "rgb(255, 255, 255)" && gc(S) && !/rgba\(\d*, \d*, \d*, 0\)/.test(S) && S !== "transparent") {
          var F;
...
const Et = te({
  ...
  setup: function(t, n) {
    ...
    return function() {
      ...
      return m("div", {
        class: i.value
      }, [zn((u = r.default) === null || u === void 0 ? void 0 : u.call(r))]);
    };
  }
});
...
const ke = te({
  ...
  slots: ["icon"],
  setup: function(t, n) {
    var r = n.slots, a = n.attrs, o = n.emit, c = pe("btn", t), i = c.prefixCls, u = c.autoInsertSpaceInButton, d = c.direction, v = c.size, l = zr.useInject(), f = l.size, p = be(null), y = be(void 0), E = !1, _ = be(!1), j = be(!1), w = N(function() {
      return u.value !== !1;
    }), $ = N(function() {
    ...
    var M = N(function() {
      ...
      return x = {}, L(x, "".concat(g), !0), L(x, "".concat(g, "-").concat(T), T), L(x, "".concat(g, "-").concat(F), F !== "default" && F), L(x, "".concat(g, "-").concat(C), C), L(x, "".concat(g, "-loading"), _.value), L(x, "".concat(g, "-background-ghost"), D && !Ge(T)), L(x, "".concat(g, "-two-chinese-chars"), j.value && w.value), L(x, "".concat(g, "-block"), K), L(x, "".concat(g, "-dangerous"), !!he), L(x, "".concat(g, "-rtl"), d.value === "rtl"), x;
    }), A = function() {
      var T = p.value;
      if (!(!T || u.value === !1)) {
        var R = T.textContent;
        E && Rn(R) ? j.value || (j.value = !0) : j.value && (j.value = !1);
      }
    }, b = function(T) {
    ...
    }), Xe(A), ta(A), Bn(function() {
      y.value && clearTimeout(y.value);
    }), function() {
      var x, T, R = t.icon, F = R === void 0 ? (x = r.icon) === null || x === void 0 ? void 0 : x.call(r) : R, D = zn((T = r.default) === null || T === void 0 ? void 0 : T.call(r));
...
const Oc = (e) => {
  e.component("DemoButton", ia), e.use(ke);
}, Sc = { install: Oc };
export {
  ia as DemoButton,
  Sc as default
